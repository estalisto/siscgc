...
/**
 * LcGestionesTmp22Id generated by hbm2java
 */
public class LcGestionesTmp22Id  implements java.io.Serializable {
    ...
    public LcGestionesTmp22Id() {
    }

    public LcGestionesTmp22Id(Integer idGestion, Integer idDeudor, Integer idCliente, Integer idEmpleado, Integer idTipoGestion, Integer idTipoResultado, String observacion, Date fechaTransaccion, String estado) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LcGestionesTmp22Id) ) return false;
		 LcGestionesTmp22Id castOther = ( LcGestionesTmp22Id ) other; 
         
		 return ( (this.getIdGestion()==castOther.getIdGestion()) || ( this.getIdGestion()!=null && castOther.getIdGestion()!=null && this.getIdGestion().equals(castOther.getIdGestion()) ) )
 ...
 && ( (this.getEstado()==castOther.getEstado()) || ( this.getEstado()!=null && castOther.getEstado()!=null && this.getEstado().equals(castOther.getEstado()) ) );
   ...
   public int hashCode() {
         ...
         result = 37 * result + ( getIdGestion() == null ? 0 : this.getIdGestion().hashCode() );
