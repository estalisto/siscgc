...
if(!permisos_roles_cal.contains(RolEmpleado)){
  ...
  datos = gfc.fnc_ConsultaRecuperadoxUsuario(iDGSGEmpresaID,iDGSSucursalID,iDGSmi_empleado,iDGStcartera,iDGStsub_cartera,GSfecha_ini,GSfecha_fin);
...
<body>
   <div class='col-lg-12' id='grafico_dash2' >
    <!--div  id='grafico_dash' -->
        <div class='box box-warning'>
            <div class='box-header with-border'>
                <h3 class='box-title'>Valores Recuperado Por Gestor</h3>
                <div class='box-tools pull-right'>
                    <button type='button' class='btn btn-box-tool' data-widget='collapse'><i class='fa fa-minus'></i></button>
                </div>
            </div>
            <div class='box-body'>
                <div id='recuperado_user' >
     ...
     <!--div class='box box-warning'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Valores Recuperado </h3>
                  <div class='box-tools pull-right'>
                    <button type='button' class='btn btn-box-tool' data-widget='collapse'><i class='fa fa-minus'></i></button>
                  </div>
                </div>
...
<script>
        ...
        /* document.getElementById("recuperado_gestor").innerHTML ="";
           document.getElementById("recuperado_gestor").innerHTML =
         "<div  id='grafico_dash' ><div class='box box-warning'>"+
"<div class='box-header with-border'><h3 class='box-title'>Valores Recuperado Por Gestor</h3><div class='box-tools pull-right'>"+
"<button type='button' class='btn btn-box-tool' data-widget='collapse'><i class='fa fa-minus'></i></button>"+
"</div></div><div class='box-body'><div id='recuperado_user' ></div></div>"+
"<div class='box-footer clearfix'><!--a href='#' onclick='borrar_grafico()' class='btn btn-sm btn-default '>Consultar</a--></div>"+
"</div></div>";*/
      google.charts.load('current', {'packages':['bar']});
      google.charts.setOnLoadCallback(drawChartRecaudacion);
}

        function drawChartRecaudacion() {
        ...
        var chart = new google.charts.Bar(document.getElementById('recuperado_user'));
